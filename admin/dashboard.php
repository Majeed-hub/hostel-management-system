      ...
      <div class="c-dashboardInfo col-lg-3 col-md-6">
        <div class="wrap">
          <h4 class="heading heading5 hind-font medium-font-weight c-dashboardInfo__title">Registered Students
            ...
            </svg></h4><span class="hind-font caption-12 c-dashboardInfo__count"><?php include 'counters/student-count.php'?></span>
        </div>
      </div>
      <div class="c-dashboardInfo col-lg-3 col-md-6">
        <div class="wrap">
          <h4 class="heading heading5 hind-font medium-font-weight c-dashboardInfo__title">Total Rooms
            ...
            </svg></h4><span class="hind-font caption-12 c-dashboardInfo__count"><?php include 'counters/room-count.php'?></span><span
      ...
      <div class="c-dashboardInfo col-lg-3 col-md-6">
        <div class="wrap">
          <h4 class="heading heading5 hind-font medium-font-weight c-dashboardInfo__title">Booked Rooms
            ...
            </svg></h4><span class="hind-font caption-12 c-dashboardInfo__count"><?php include 'counters/booked-count.php'?></span>
        </div>
      </div>
      <div class="c-dashboardInfo col-lg-3 col-md-6">
        <div class="wrap">
          <h4 class="heading heading5 hind-font medium-font-weight c-dashboardInfo__title">Featured Course
            ...
            </svg></h4><span class="hind-font caption-12 c-dashboardInfo__count"><?php include 'counters/course-count.php'?></span>
        </div>
      </div>
    </div>
  </div>
